...
function safeWriteFlag(flagPath, content) {
  try {
    ...
    // NOTE: upstream refuses if flagDir is a symlink, but ~/.claude is commonly
    // symlinked to a dotfiles repo — legitimate, not attacker redirect. The
    // symlink-safety that matters is on the target file itself, handled next.
